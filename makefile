...
err: 
	gcc -g -lefence -std=c99 -o noiz utils/utils.c utils/noiz_utils.c effects/effects.c cache/cache.c scripting/p_func.c fosica.c  -lpthread -lm -L/usr/local/lib -ljansson -lportaudio -lsndfile -lsamplerate -Wl,-rpath -Wl,/usr/local/lib
opt: 
	gcc -Wall -Wextra -O3 -std=c99 -o noiz utils/utils.c utils/noiz_utils.c effects/effects.c cache/cache.c scripting/p_func.c fosica.c  -lpthread -lm -L/usr/local/lib -ljansson -lportaudio -lsndfile -lsamplerate -Wl,-rpath -Wl,/usr/local/lib
nw:
